...
The My Cool Package Node.js team is pleased to announce version ${version.version} of the \`my-cool-package\` package!

${highlights}
${history}
## Documentation

We invite you to try the \`my-cool-package\` library immediately.
`;
